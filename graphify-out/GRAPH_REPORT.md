...
## Corpus Check
- 98 files · ~161,543 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 718 nodes · 1342 edges · 35 communities (29 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.6)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5ec86aef`
...
Cohesion: 0.04
Nodes (47): autoprefixer, dotenv, exceljs, imap-simple, mailparser, @neondatabase/serverless, node-forge, oxlint (+39 more)
...
Cohesion: 0.06
Nodes (16): CryptoManager, adulterado, bufferDecrypt, bufferOriginal, { encrypted: encBin, iv: ivBin }, { encrypted: encSenha, iv: ivSenha }, senhaDecrypt, thumbprint (+8 more)
...
## Knowledge Gaps
- **265 isolated node(s):** `$schema`, `oxc`, `react/rules-of-hooks`, `warn`, `MESES` (+260 more)
...
- **Why does `calcularImpostos()` connect `valorDevido` to `6. Regras de negócio financeiro`, `Financial.jsx`?**
