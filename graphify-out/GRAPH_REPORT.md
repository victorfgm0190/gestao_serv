...
## Corpus Check
- 86 files · ~109,410 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 568 nodes · 1063 edges · 30 communities (25 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `73de8cc7`
...
Cohesion: 0.06
Nodes (41): CopyButton(), fmt(), MemoriaCalculo(), Passo(), todayBR(), KIND_LABEL, Billing(), fetchFiscalParams() (+33 more)
...
## Knowledge Gaps
- **201 isolated node(s):** `$schema`, `oxc`, `react/rules-of-hooks`, `warn`, `MESES` (+196 more)
...
- **Why does `requireAuth()` connect `payable-payments.js` to `6. Regras de negócio financeiro`, `payables-victor.js`, `valorDevido`, `time-entries.js`, `cron-sync.js`, `export-payables-fabricio.js`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `react` connect `main.jsx` to `.oxlintrc.json`, `Financial.jsx`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `ORDEM_KIND` connect `payables-victor.js` to `valorDevido`, `Financial.jsx`?**
