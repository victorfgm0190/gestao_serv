...
## Corpus Check
- 85 files · ~103,549 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 551 nodes · 1034 edges · 30 communities (25 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c66ed9ec`
...
2. `6. Regras de negócio financeiro` - 21 edges
3. `3. Banco de dados — tabelas, colunas e tipos` - 19 edges
4. `react` - 18 edges
5. `valorDevido()` - 17 edges
6. `handler()` - 16 edges
7. `r2()` - 15 edges
...
Cohesion: 0.12
Nodes (37): handler(), periodFromDate(), recalcParent(), TABLES, estornarSessao(), handler(), pagarComRateio(), pagarDistribuido() (+29 more)
...
Cohesion: 0.07
Nodes (39): aliquotaEfetiva(), calcINSS(), calcularImpostos(), faixaFor(), parametrosFiscais(), PARAMS_PADRAO, proLaboreDoMes(), r2() (+31 more)
...
Cohesion: 0.05
Nodes (43): 10. Pendências conhecidas, 1. Visão geral, 2. Empresas e clientes, 4. APIs ativas (`/api/`), 5. Telas (`/src/pages/`), 6. Regras de negócio financeiro, 7. Contratos existentes no banco, 8. Workflow de desenvolvimento (+35 more)
...
## Knowledge Gaps
- **191 isolated node(s):** `$schema`, `oxc`, `react/rules-of-hooks`, `warn`, `MESES` (+186 more)
