...
## Corpus Check
- 110 files · ~170,956 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 815 nodes · 1518 edges · 53 communities (40 shown, 13 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.6)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fa090015`
...
Cohesion: 0.07
Nodes (42): react, companies, Layout(), useNotifications(), clearToken(), getToken(), getUser(), installFetchInterceptor() (+34 more)
...
Cohesion: 0.06
Nodes (70): handler(), periodFromDate(), recalcParent(), TABLES, calcularDistribuicao(), estornarSessao(), handler(), pagarCompensacao() (+62 more)
...
Cohesion: 0.12
Nodes (17): axios, dotenv, exceljs, node-forge, nodemailer, dependencies, axios, dotenv (+9 more)
...
## Knowledge Gaps
- **297 isolated node(s):** `$schema`, `oxc`, `react/rules-of-hooks`, `warn`, `DESTINATARIOS` (+292 more)
...
- **Why does `requireAuth()` connect `payable-payments.js` to `6. Regras de negócio financeiro`, `payables-victor.js`, `time-entries.js`, `export-payables-fabricio.js`, `cron-nfse-check.test.js`, `payment-source-tracker.js`, `email-ingest.js`?**
  _High betweenness centrality (0.123) - this node is a cross-community bridge._
- **Why does `react` connect `main.jsx` to `FiscalObligations.jsx`, `Financial.jsx`, `.oxlintrc.json`, `Billing.jsx`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `calcularImpostos()` connect `6. Regras de negócio financeiro` to `Financial`, `Financial.jsx`?**
