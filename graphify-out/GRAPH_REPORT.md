...
## Corpus Check
- 86 files · ~111,988 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 571 nodes · 1066 edges · 31 communities (26 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `55c2dd5c`
...
Cohesion: 0.06
Nodes (43): aliquotaEfetiva(), calcINSS(), calcularImpostos(), faixaFor(), parametrosFiscais(), PARAMS_PADRAO, proLaboreDoMes(), r2() (+35 more)
...
Cohesion: 0.24
Nodes (16): estornar(), handler(), listar(), num(), pagar(), round2(), saldoAberto(), DESCRICAO_KIND (+8 more)
...
## Knowledge Gaps
- **204 isolated node(s):** `$schema`, `oxc`, `react/rules-of-hooks`, `warn`, `MESES` (+199 more)
...
- **Why does `requireAuth()` connect `payable-payments.js` to `6. Regras de negócio financeiro`, `payables-victor.js`, `time-entries.js`, `taxCalc.js`, `cron-sync.js`, `export-payables-fabricio.js`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `react` connect `main.jsx` to `valorDevido`, `.oxlintrc.json`, `Financial.jsx`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `ORDEM_KIND` connect `payables-victor.js` to `taxCalc.js`, `Financial.jsx`?**
