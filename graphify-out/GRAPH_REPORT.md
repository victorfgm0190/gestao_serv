...
## Corpus Check
- 71 files · ~61,166 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 392 nodes · 616 edges · 31 communities (26 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `06758fe9`
...
- `saldoAberto()` --calls--> `remainingBalance()`  [EXTRACTED]
  api/fiscal-payments.js → lib/payment-status.js
...
Cohesion: 0.07
Nodes (40): react, CopyButton(), companies, Layout(), useNotifications(), todayBR(), clearToken(), getToken() (+32 more)
...
Cohesion: 0.51
Nodes (9): estornar(), handler(), listar(), num(), pagar(), recalcular(), round2(), saldoAberto() (+1 more)
