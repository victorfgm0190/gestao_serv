...
## Corpus Check
- 79 files · ~84,271 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 473 nodes · 868 edges · 30 communities (25 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a372c835`
...
3. `react` - 18 edges
4. `handler()` - 16 edges
5. `valorDevido()` - 15 edges
6. `6. Regras de negócio financeiro` - 15 edges
7. `round2()` - 13 edges
8. `num()` - 13 edges
...
Cohesion: 0.11
Nodes (50): acumular12(), apurar(), brl(), calcularApuracao(), chaveCompetencia(), chaveOrdinal(), contextoRedistribuicao(), corrigirEscritorio() (+42 more)

### Community 5 - "payables-victor.js"
Cohesion: 0.23
Nodes (17): handler(), periodFromDate(), recalcParent(), TABLES, estornarSessao(), handler(), pagarDistribuido(), recalcVictorParent() (+9 more)
...
Cohesion: 0.05
Nodes (37): 10. Pendências conhecidas, 1. Visão geral, 2. Empresas e clientes, 4. APIs ativas (`/api/`), 5. Telas (`/src/pages/`), 6. Regras de negócio financeiro, 7. Contratos existentes no banco, 8. Workflow de desenvolvimento (+29 more)
...
## Knowledge Gaps
- **156 isolated node(s):** `$schema`, `oxc`, `react/rules-of-hooks`, `warn`, `TABLES` (+151 more)
...
- **Why does `react` connect `main.jsx` to `Financial.jsx`, `.oxlintrc.json`, `Financial.jsx`?**
