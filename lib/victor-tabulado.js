...
//
// ⚠️ É a ordem de EXIBIÇÃO E de absorção desta tabela, e ela é deliberadamente diferente
// de ORDEM_CATEGORIA (lib/victor-rateio.js), que consome DAS → INSS → Honorários. Mudar
// aquela mudaria o que o `?action=pagar-com-rateio` grava — inclusive pelos cards que já
// estão em produção —, e a ordem só altera resultado quando o dinheiro não cobre tudo.
