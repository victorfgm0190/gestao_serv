...
ok(txt('pAliq') === '2.00', 'pAliq formatado')
...
ok(txt('CEP') === '01001000', 'CEP só com dígitos')
...
ok(id === 'DPS3550308112345678000190' + '00001' + '000000000000007', 'Id composto por município+CNPJ+série+nDPS')
