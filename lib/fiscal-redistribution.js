...
//
// ── REATIVADA EM 2026-08-15 (decisão do Victor) ───────────────────────────────────────
// A flag existir foi o que tornou a volta barata: uma linha, e os cinco consumidores
// (gravação, cascata exibida, colunas ORIGINAL/ABSORVEU, `a_redistribuir` e a conferência
// da NF) voltaram juntos ao comportamento anterior.
//
// ⚠️ O QUE A VOLTA IMPLICA, e que não é código: o imposto passa a ser pago pelo Victor
// RECEBENDO MENOS. Se a guia também for quitada com caixa (aba Pagar Victor ou /fiscal),
// o mesmo tributo sai duas vezes do bolso dele. Quem escolhe é a operação, não o sistema —
// mas o rastreamento agora registra a absorção (`destination_category='impostos'`,
// `payment_id NULL`), então dá para VER quanto já foi pago por desconto antes de pagar a
// guia de novo.
export const ABSORVER_IMPOSTO_NO_PAYABLE = true
